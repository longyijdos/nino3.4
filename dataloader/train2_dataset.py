...
class train2_dataset(Dataset):
    def __init__(self,data_path):
        ...
        #截取选定时间内地数据
        sst_time_range=(self.sstA["time"].dt.year >= 1871) & (self.sstA["time"].dt.year <= 1973)
        ssh_time_range=(self.sshA["time"].dt.year >= 1871) & (self.sstA["time"].dt.year <=1973)
